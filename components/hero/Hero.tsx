  ...
  return (
    ...
    >
      <div className="flex items-center justify-center gap-3 sm:gap-5 mb-14 sm:mb-16">
        <span aria-hidden className="h-px w-6 sm:w-16 bg-[#1a1d56]/30 shrink-0" />
        <p className="whitespace-nowrap text-[10px] sm:text-xs font-semibold uppercase tracking-[0.12em] sm:tracking-[0.18em] text-[#1a1d56]">
      ...
      <h1 className="text-2xl sm:text-4xl lg:text-5xl font-semibold tracking-tight text-zinc-900 leading-tight max-w-5xl mx-auto text-center text-balance">
        Offerta dedicata ai clienti <span className="text-[#1a1d56]">Banca Ifis</span>
      ...
      <ul className="mt-14 sm:mt-16 grid gap-x-8 gap-y-2.5 sm:grid-cols-2">
        {advantages.map(([bold, rest]) => (
          ...
          >
            <span
              aria-hidden
              className="mt-[3px] shrink-0 text-[#1a1d56] text-xs font-bold"
            >
              ✓
            </span>
            <span>
      ...
      <div className="mt-14 sm:mt-16 flex flex-col sm:flex-row items-center justify-center gap-3">
        <a
          href="#pacchetti"
          className="inline-flex h-12 w-full sm:w-auto items-center justify-center rounded-full bg-[#1a1d56] px-7 text-base font-medium text-white hover:bg-[#12143d] transition-colors"
        >
          Configura la tua postazione
        </a>
        <a
          href="#apple"
          className="inline-flex h-12 w-full sm:w-auto items-center justify-center rounded-full border border-[#1a1d56] bg-transparent px-7 text-base font-medium text-[#1a1d56] hover:bg-[#1a1d56]/5 transition-colors"
        >
          Vai ai prodotti
        </a>
      </div>
