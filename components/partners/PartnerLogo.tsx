...
export function PartnerLogo({ partner }: { partner: Partner }) {
  ...
  const baseClass =
    "max-h-9 sm:max-h-12 w-auto max-w-[90px] sm:max-w-[120px] object-contain grayscale opacity-60 mix-blend-multiply group-hover:grayscale-0 group-hover:opacity-100 transition duration-200";
